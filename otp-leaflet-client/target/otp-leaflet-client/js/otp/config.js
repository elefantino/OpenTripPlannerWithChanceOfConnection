...
otp.config = {
    ...
    //siteName            : "My OTP Instance", //BetekhtinaElena
    ...
    modules : [
        ...
        //BetekhtinaElena: Analyst module is disabled since it is out of the topic
        /*{
            id : 'analyst',
    ...
    infoWidgets: [
        {
            ...
            content: '<p>This trip planner is a part of the Master Thesis of Betekhtina Elena written in collaboration with the University of Tampere, Finland.</p>'+
        ...
        },
        {
            ...
            content: '<p>Comments? Contact by e-mail betekhtina.elena.x@student.uta.fi</p>'
        },           
    ],
