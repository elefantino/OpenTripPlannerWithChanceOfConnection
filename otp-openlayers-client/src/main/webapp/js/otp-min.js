...
if(reproject)
ll=ll.transform(otp.util.GEOGRAPHIC,otp.util.WEB_MERCATOR);return ll;},RTE_ICON_SIZE:new OpenLayers.Size(105,34),RTE_ICON_OFFSET:new OpenLayers.Pixel(0,-34),RTE_ICON_OFFSET_LEFT:new OpenLayers.Pixel(-105,-34),ST_END_SIZE:new OpenLayers.Size(21,39),ST_END_OFFSET:new OpenLayers.Pixel(-10,-39),DISK_SIZE:new OpenLayers.Size(10,10),DISK_OFFSET:new OpenLayers.Pixel(-5,-5),useCustomIconsForAgencies:[],markerGraphicMapping:{walkMarker:'images/map/trip/mode/walk.png',walkMarkerLeft:'images/map/trip/mode/walk-left.png',bicycleMarker:'images/map/trip/mode/bicycle.png',fromWalkMarker:'images/map/trip/start-walk.png',fromBicycleMarker:'images/map/trip/start-bicycle.png',fromCarMarker:'images/map/trip/start-car.png',toMarker:'images/map/trip/end.png',fromMarker:'images/map/trip/start.png',diskMarker:'images/map/trip/xferdisk.png',routeMarker:function(feature){var imagePathOptions=Ext.apply({},{imageType:'marker'},feature.attributes);return otp.util.imagePathManager.imagePath(imagePathOptions);},routeMarkerLeft:function(feature){var imagePathOptions=Ext.apply({},{imageType:'marker'},feature.attributes);return otp.util.imagePathManager.imagePath(imagePathOptions);}},getMarkerStyle:function(){var template={externalGraphic:"${getExternalGraphic}",graphicOpacity:1};var graphicMapping=otp.util.OpenLayersUtils.markerGraphicMapping;var olutils=this;var context={getExternalGraphic:function(feature){var externalGraphic=graphicMapping[feature.attributes.type];return typeof externalGraphic==='function'?externalGraphic.call(olutils,feature):externalGraphic;}};var style=new OpenLayers.Style(template,{context:context});return style;},getMarkerUniqueValueRules:function(){return{walkMarker:{graphicWidth:this.RTE_ICON_SIZE.w,graphicHeight:this.RTE_ICON_SIZE.h,graphicXOffset:this.RTE_ICON_OFFSET.x,graphicYOffset:this.RTE_ICON_OFFSET.y},walkMarkerLeft:{graphicWidth:this.RTE_ICON_SIZE.w,graphicHeight:this.RTE_ICON_SIZE.h,graphicXOffset:this.RTE_ICON_OFFSET_LEFT.x,graphicYOffset:this.RTE_ICON_OFFSET_LEFT.y},fromWalkMarker:{graphicWidth:this.ST_END_SIZE.w,graphicHeight:this.ST_END_SIZE.h,graphicXOffset:this.ST_END_OFFSET.x,graphicYOffset:this.ST_END_OFFSET.y},fromBicycleMarker:{graphicWidth:this.ST_END_SIZE.w,graphicHeight:this.ST_END_SIZE.h,graphicXOffset:this.ST_END_OFFSET.x,graphicYOffset:this.ST_END_OFFSET.y},fromCarMarker:{graphicWidth:this.ST_END_SIZE.w,graphicHeight:this.ST_END_SIZE.h,graphicXOffset:this.ST_END_OFFSET.x,graphicYOffset:this.ST_END_OFFSET.y},toMarker:{graphicWidth:this.ST_END_SIZE.w,graphicHeight:this.ST_END_SIZE.h,graphicXOffset:this.ST_END_OFFSET.x,graphicYOffset:this.ST_END_OFFSET.y},fromMarker:{graphicWidth:this.ST_END_SIZE.w,graphicHeight:this.ST_END_SIZE.h,graphicXOffset:this.ST_END_OFFSET.x,graphicYOffset:this.ST_END_OFFSET.y},diskMarker:{graphicWidth:this.DISK_SIZE.w,graphicHeight:this.DISK_SIZE.h,graphicXOffset:this.DISK_OFFSET.x,graphicYOffset:this.DISK_OFFSET.y},routeMarker:{graphicWidth:this.RTE_ICON_SIZE.w,graphicHeight:this.RTE_ICON_SIZE.h,graphicXOffset:this.RTE_ICON_OFFSET.x,graphicYOffset:this.RTE_ICON_OFFSET.y},routeMarkerLeft:{graphicWidth:this.RTE_ICON_SIZE.w,graphicHeight:this.RTE_ICON_SIZE.h,graphicXOffset:this.RTE_ICON_OFFSET_LEFT.x,graphicYOffset:this.RTE_ICON_OFFSET_LEFT.y}};},makeMarker:function(x,y,attributes)
...
added_params.bannedRoutes=this.bannedRoutes;if(this.bannedStops)
added_params.bannedStops=this.bannedStops;var data={method:'GET',url:this.url,waitMsg:this.locale.tripPlanner.labels.submitMsg,params:added_params}
...
this.bannedRoutes=params.bannedRoutes;if(typeof(params.bannedStops)=='string')
this.bannedStops=params.bannedStops;if(params.routerId)
...
else if(mode==='bicycle'){verb=this.locale.instructions.bike_toward;template='TP_BICYCLE_LEG';containsBikeMode=true;}else if(mode==='car'){verb=this.locale.instructions.drive_toward;template='TP_CAR_LEG';containsDriveMode=true;}else{verb=this.locale.instructions.move_toward;}
